...
<html lang="en">
  <head>
    <title>my java front end application build using maven</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
    <nav class="navbar navbar-expand-md navbar-dark bg-dark sticky-top shadow-sm">
        <div class=" container" >
        <a class="navbar-brand" href="index.jsp">BRADDA</a>
    ...
    <div class="container py-4">
        ...
        <div class="card-columns">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h4 class="card-title">Maven && Git</h4>
                    <p class="card-text">Text</p>
                </div>
            </div>
            <div class="card">
